rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (Alexa show me the weather)
...
curlCommand = "curl " + hubitatIp + "apps/api/1376/devices/1622?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
...
If currentValue = "off" Then
  ...
  curlCommand = "curl " + hubitatIp + "apps/api/1376/devices/1622/off?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
  oShell.Exec(curlCommand)
  oShell.Run myPath+"\PcControl\AlexaShowMe\weather.bat - Shortcut.lnk",0,false
End If
