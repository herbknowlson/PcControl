...
curlCommand = "curl " + hubitatIp + "apps/api/1376/devices/1672?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
...
If currentValue = "off" Then
  ...
  curlCommand = "curl " + hubitatIp + "apps/api/1376/devices/1672/off?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
