rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (Alexa show me Chrome)
rem  Use curl in Windows to execute a URL for the specific device in Hubitat - device ID: 1672
...
Dim curlCMD
curlCommand = "curl http://192.168.2.84/apps/api/1376/devices/1672?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
...
If currentValue = "off" Then
  ...
  curlCommand = "curl http://192.168.2.84/apps/api/1376/devices/1672/off?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
  oShell.Exec(curlCommand)
  WScript.Echo "Do something"
  oShell.Run myPath+"\PcControl\AlexaShowMe\chrome.bat - Shortcut.lnk",0
End If
