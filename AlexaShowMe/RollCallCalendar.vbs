rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (show me the calendar)
rem  Use curl in Windows to execute a URL for the specific device in Hubitat - device ID: 1626 
...
curlCommand = "curl " + hubitatIp + "apps/api/1376/devices/1626?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
...
If currentValue = "off" Then
  ...
  curlCommand = "curl " + hubitatIp + "apps/api/1376/devices/1626/off?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
  oShell.Exec(curlCommand)
  oShell.Run myPath+"\PcControl\AlexaShowMe\calendar.bat - Shortcut.lnk"
End If
