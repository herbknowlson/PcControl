...
myPath="C:\Users\herbk\Dropbox"
  ...
  rem ===========================================================================
  actionCounterFile = myPath+"\PcControl\Dashboard\CounterFile.txt"

  Set fso = CreateObject("Scripting.FileSystemObject")
  Set f = fso.OpenTextFile(actionCounterFile)
  ...
  rem ==========================================================================
  Set objFileToWrite = CreateObject("Scripting.FileSystemObject").OpenTextFile(actionCounterFile,2,true)
