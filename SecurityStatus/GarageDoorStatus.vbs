rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (Outside garage door)
rem  Use curl in Windows to execute a URL for the specific device in Hubitat - device ID: 1649 
rem -------------------------------------------------------------------------------------------------
rem WScript.Echo "-------------------------------------------------------------"
...
rem WScript.Echo "current value: " + currentValue
  ...
  wshSystemEnv("GarageDoorStatus") = currentValue
  oShell.Run myPath+"\PcControl\SecurityStatus\GarageDoorStatus.bat - Shortcut.lnk ",0,false
WScript.Quit