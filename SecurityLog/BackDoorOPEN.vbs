rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (Security log - back door OPEN))
rem  Use curl in Windows to execute a URL for the specific device in Hubitat - device ID: 1629 
...
If currentValue = "off" Then
  ...
  oShell.Run myPath+"\PcControl\SecurityLog\BackDoorOPEN.bat - Shortcut.lnk",0,true
End If
