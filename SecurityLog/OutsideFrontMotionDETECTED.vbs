rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (Security log - outside front motion DETECTED)
rem  Use curl in Windows to execute a URL for the specific device in Hubitat - device ID: 1633 
...
Dim curlCMD
curlCommand = "curl "+ hubitatIp + "apps/api/1376/devices/1633?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
...
If currentValue = "off" Then
  ...
  curlCommand = "curl "+ hubitatIp + "apps/api/1376/devices/1633/off?access_token=6c5d7775-2d6a-4786-ae45-3942346fd0d5"
  oShell.Exec(curlCommand)
  oShell.Run myPath+"\PcControl\SecurityLog\OutsideFrontMotionDETECTED.bat - Shortcut.lnk",0
End If
