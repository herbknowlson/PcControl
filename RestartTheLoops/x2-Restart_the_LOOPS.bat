...
rem --------------------------------------------------------------
START %myPath%"\PcControl\restartTheLoops\InterrogateLoop1.bat - Shortcut.lnk"

TIMEOUT 5
rem --------------------------------------------------------------
rem                 Redo the formula
rem --------------------------------------------------------------
rem start "Smart home dashboard" "https://docs.google.com/spreadsheets/d/1zxylrlUsqf4W9TLM8twuCusCSwMnDL6_rtt_ELW10wc/edit#gid=1175759561"
