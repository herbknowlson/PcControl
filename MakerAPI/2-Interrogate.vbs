...
rem -----------------------------------------------------------
rem      Note: This script will be on the PC called by a batch file (1-TheLoop) that is running a loop
rem  
...
rem -----------------------------
  ...
  shell.CurrentDirectory = "C:\Users\herbk\Dropbox\gitHub\PcControl\MakerAPI\"
rem -----------------------------------------------------------------------------------------
