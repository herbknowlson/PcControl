rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (Smart home action01)
...
wshSystemEnv("notesAction01") = newNotes
...
If currentValue = "off" Then
  ...
  oShell.Run "C:\Users\herbk\Dropbox\PcControl\SmartHomeTimer\action01.bat",0,false
