rem -------------------------------------------------------------------------------------------------
rem  Use the Hubitat Maker API to interrogate the value of virtual switch  (Alexa recycle Wyze cams)
rem  Use curl in Windows to execute a URL for the specific device in Hubitat - device ID: 1654 
...
If currentValue = "off" Then
  ...
  rem oShell.Run myPath+"\PcControl\Wyze\WyzeCamEast.vbs",0,false
  rem oShell.Run myPath+"\PcControl\Wyze\WyzeCamWest.vbs",0,false
End If
